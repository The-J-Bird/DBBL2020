...
$credits = array(	'Val Catella',
					...
					'Ian Williams',
					'Johnathan Revell');
define('NAFLM_VERSION', '3.0.01');
define('NAFLM_BUILD_DATE', '1st  February 2023');
define('CONTENT_VERSION', 'Spike 15');
define('CONTENT_DETAIL', 'Blood Bowl 2020, including Death Zone and Spike 11-15');
define('CONTENT_DATE', 'October 2022');
$naflmcredits = array(	
						'Val Catella',
						'Anthony Baez',
						'byrnesvictim',
...
require_once('lib/game_data_bb2020.php'); # GAME_DATA_BB2020 MUST be loaded.
# Module settings
