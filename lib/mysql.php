...
$CT_cols = array(
    ...
    'chr'      => 'TINYINT UNSIGNED',    # ma, st, ag, pa, av (inj, def and ach)
    'chr_ua'   => 'TINYINT SIGNED',      # Unadjusted ma, st, ag, pa, av
    'elo'      => 'FLOAT',
...
$core_tables = array(
    ...
    'match_data' => array(
        ...
        'cp'            => 'TINYINT UNSIGNED',
        'td'            => 'TINYINT UNSIGNED',
        'deflct'        => 'TINYINT UNSIGNED',
        'intcpt'        => 'TINYINT UNSIGNED',
        'bh'            => 'TINYINT UNSIGNED',
        'si'            => 'TINYINT UNSIGNED',
        'ki'            => 'TINYINT UNSIGNED',
        'misc'          => 'TINYINT UNSIGNED',
	...
	'special_rules' => array(
        'rule_id'   => $CT_cols['rule_id'].' NOT NULL PRIMARY KEY',
        'name'      => $CT_cols['name'],
        'cat' => 'VARCHAR(1)',
	),
);
...
$ES_fields = array(
	...
	"deflection_made" 					=> array(	"short" => "cp_def",
													"type"  => "MEDIUMINT SIGNED NOT NULL DEFAULT 0",
													"group" => "Defensive stats",
													"desc"  => "Number of times the player has deflected a thrown ball."),
...
function setup_database() {
    ...
    Message::create(array(
        ...
        'title'      => 'NAFLM 2020 installed!',
        'msg'        => 'Congratulations! You have successfully installed the NAFLM 2020 League Manager. See "About" for more information. Ensure you change the root account password immediately.'));
    // Done!
    mysql_close($conn);
    return true;
}
...
function upgrade_database($version, $opts, $upgradeSQLs) {
    ...
    switch ($version) {
        case '2020':
            ...
            global $DEA, $stars, $skillarray; # Make global so that below include(s) will overwrite their values.
            require('lib/game_data_bb2020.php'); # Load BB2020 data.
